...
class GrowthChartViewController : UIViewController, ChartViewDelegate{
    ...
    func loadGeneralDictionariesPercentilsGirl(){
        ...
        dictWeightGirl = [0 : [2.4,3.2,4.15], 1 : [3.15, 4.1, 5.3],2 : [3.9,5,6.4], 3: [4.6,5.85,7.4], 4 : [5.1,6.4,8.1], 5 : [5.5,6.9,8.7], 6: [5.8,7.3,9.2], 7 : [6.1,7.6,9.65], 8 : [6.3,8,10],9 : [6.6,8.2,10.4],10 : [6.8,8.5,10.7],11 : [7,8.7,11], 12: [7.15,8.95,11.35]]
        
        dictWeightGirl2 = [0 : [7.15,8.95,11.35], 1 : [7.3,9.2,11.6],2 : [7.5,9.4,11.9],3 : [7.7,9.6,12.2],4 : [7.8,9.8,12.4],5 : [8,10,12.7] , 6 : [8.2,10.2,13],7: [8.4,10.4,13.2],8 : [8.5,10.6,13.5],9 :[8.6,10.8,13.8],10 : [8.8,11,14.1],11 : [9,11.3,14.3], 12 : [9.2, 11.5, 14.75]]
        
        dictWeightGirl3 = [0 : [9.2, 11.5, 14.75], 1 : [9.4, 11.75, 15],2 : [9.5,12,15.2 ],3 : [9.6,12.1,15.4],4 : [9.8,12.3,15.8] , 5 : [10,12.5,16],6 : [10.1,12.7,16.2],7 : [10.2,12.9,16.5],8 :[10.4,13.1,16.8],9 : [10.6,13.3,17],10 : [10.7,13.5,17.3], 11 : [10.8, 13.6, 17.6], 12: [11,13.8,17.8]]
        
        dictWeightGirl4 = [0 : [11,13.8,17.8], 1 : [11.1,14,18.1],2 : [11.2,14.2,18.4],3 : [11.4,14.4,18.6],4 : [11.5,14.6,19] , 5 : [11.6,14.8,19.2],6 : [11.8,15,19.4],7 : [11.9,15.2,19.8],8 :[12,15.4,20],9 : [12.2,15.6,20.3],10 : [12.3,15.7,20.6], 11 : [12.4,15.8,20.8], 12: [12.5,16.1,21]]
    ...
    func setChart(values : [Double: [Double]], valuesChild : [Double]) {
        ...
        chart.setVisibleXRange(minXRange: 11.0, maxXRange: 12.0)
        chart.data = chartData
