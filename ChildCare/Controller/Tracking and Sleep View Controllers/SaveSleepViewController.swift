...
class SaveSleepViewController : UITableViewController{
    ...
    @IBAction func saveButtonPressed(_ sender: UIButton) {
        ...
        if childApp.name.isEmpty || (textFieldEnd.text!.isEmpty && textFieldDuration.text!.isEmpty) || textFieldStart.text!.isEmpty {
            
            let alert = UIAlertController(style: .alert)
            if childApp.name.isEmpty{
                alert.set(title: "Error", font: font!, color: grayColor!)
                alert.set(message: "In order to save a sleep record at least one child has to be active in ChildCare.", font: fontLittle!, color: grayLightColor!)
            }
            else{
                alert.set(title: "Error", font: font!, color: grayColor!)
            ...
            try realm.write {
                ...
                case "Duration":
                    ...
                    if intercept == false{
                        ...
                        childApp.sleeps.append(sleepToSave)
