...
class SleepViewController : UIViewController, ChartViewDelegate{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        DispatchQueue.main.async {
            ...
            if self.registeredChildren!.count > 0 && self.childApp!.name.isEmpty{
    ...
    func loadSleepsThisWeek(date : Date){
        ...
        med0.loadSleepRecords(child: childApp!, day: arrayDatesGeneral[0])
        med1.loadSleepRecords(child: childApp!, day: arrayDatesGeneral[1])
        med2.loadSleepRecords(child: childApp!, day: arrayDatesGeneral[2])
        med3.loadSleepRecords(child: childApp!, day: arrayDatesGeneral[3])
        med4.loadSleepRecords(child: childApp!, day: arrayDatesGeneral[4])
        med5.loadSleepRecords(child: childApp!, day: arrayDatesGeneral[5])
        med6.loadSleepRecords(child: childApp!, day: arrayDatesGeneral[6])
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destinationVC = segue.destination as? HistorySleepViewController{
            destinationVC.childApp = childApp
        }
    }
