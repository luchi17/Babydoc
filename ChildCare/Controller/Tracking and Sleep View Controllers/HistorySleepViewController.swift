...
class HistorySleepViewController: UIViewController{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        loadChildrenAndSleep(selectedDate: datePicker.selectedDate ?? Date())
        DispatchQueue.main.async {
    ...
    func loadChildrenAndSleep(selectedDate : Date){
        ...
        listOfSleep = childApp?.sleeps.filter(
                ...
                .sorted(byKeyPath: "generalDateBegin", ascending: false)
...
extension HistorySleepViewController: ScrollableDatepickerDelegate {
    ...
    func datepicker(_ datepicker: ScrollableDatepicker, didSelectDate date: Date) {
        ...
        loadChildrenAndSleep(selectedDate: date)
...
extension HistorySleepViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
        ...
        if registeredChildren!.count == 0  || listOfSleep?.count == 0{
            cell.typeSleep.text = ""
            cell.duration.text = ""
            cell.starttime.text = ""
            cell.endtime.text = ""
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        else if listOfSleep?.count != 0 && !(childApp?.name.isEmpty)!{
